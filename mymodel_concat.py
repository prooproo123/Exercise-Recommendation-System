...
class Model():
    ...
    def create_model(self):
        ...
        self.knowledge_concept_ids = tf.placeholder(tf.int32, [self.args.batch_size, self.args.seq_len, 3],
                                                    name='knowledge_concept_ids')
        self.knowledge_concept_onehots = tf.placeholder(tf.float32, [self.args.batch_size, self.args.seq_len, 188],
    ...
    def train(self, train_q_data, train_qa_data, valid_q_data, valid_qa_data, train_kg_data,
        ...
        for epoch in range(0, self.args.num_epochs):
            ...
            for steps in range(training_step):
                ...
                exercise_gates_batch_seq = guan_shuffled[
                                           steps * self.args.batch_size:(steps + 1) * self.args.batch_size]
                exercise_difficulties_batch_seq = diff_shuffled[
                                                  steps * self.args.batch_size:(steps + 1) * self.args.batch_size]
                ...
                feed_dict = {self.knowledge_concept_ids: knowledge_concept_ids_batch_seq,
                             ...
                             self.exercise_difficulties: exercise_difficulties_batch_seq,
                             self.exercise_gates: exercise_gates_batch_seq}
            ...
            for s in range(valid_steps):
                ...
                valid_feed_dict = {self.knowledge_concept_ids: valid_kg, self.exercise_ids: valid_q,
                                   ...
                                   self.exercise_gates: valid_guan, self.exercise_difficulties: valid_diff}

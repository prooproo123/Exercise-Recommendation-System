...
outputFilePath = 'data/skill_builder/chunk_stand_ex_ind_con_ind.csv'
...
with open('data/skill_builder/chunk_exercise_concepts_mapping.pkl', 'wb') as f:
    pickle.dump(exercise_concepts_mapping, f)

with open('data/skill_builder/chunk_concepts_id_converter.pkl', 'wb') as f:
    pickle.dump(concepts_id_converter, f)

with open('data/skill_builder/chunk_id_concepts_converter.pkl', 'wb') as f:
...
with open('data/skill_builder/chunk_id_exercises_converter.pkl', 'wb') as f:
